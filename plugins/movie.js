...
async (conn, mek, m, { from, reply, sender, args }) => {
    try {
        ...
        const apiUrl = `https://draculazyx-xyzdrac.hf.space/api/Movie?query=${encodeURIComponent(movieName)}`;
...
`;
        ...
        await conn.sendMessage(
            ...
            {
                image: { 
                    url: movie.poster && movie.poster !== 'N/A' ? movie.poster : 'https://i.postimg.cc/dtqvMVZ1/Boyxaxdwagrp.jpg'
                },
                caption: dec,
                contextInfo: {
                    mentionedJid: [sender],
